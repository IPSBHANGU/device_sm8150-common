...
#define LOG_TAG "vendor.one.camera.motor@1.0-service.oneplus_msmnile"
...
using vendor::one::camera::motor::V1_0::ICameraMotor;
using vendor::one::camera::motor::V1_0::implementation::CameraMotor;
