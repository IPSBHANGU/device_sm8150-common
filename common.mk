...
PRODUCT_COPY_FILES += \
    ...
    vendor/caf/config/permissions/vendor.one.biometrics.fingerprint.inscreen.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/vendor.one.biometrics.fingerprint.inscreen.xml
...
# Power
PRODUCT_PACKAGES += \
    android.hardware.power@1.2-imp \
